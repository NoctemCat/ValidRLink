...
public partial class RLinkScene : Node
{
    ...
    public void ToggleConnectImpl(RLinkCS rlink)
    {
        ...
        if (rlink.SignalIsConnected(customPressed, ScenePressed))
            ...
            rlink.SignalConnect(customPressed, ScenePressed, new Godot.Collections.Array { "hello SceneExport C#" });
        ...
        rlink.SignalToggle(customPressed, ScenePressed, new Godot.Collections.Array { "hello SceneFile C#" });
    }
