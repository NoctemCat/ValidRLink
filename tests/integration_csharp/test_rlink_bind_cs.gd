...
func test_bind() -> void:
    var script: Script = get_cs_script()
    var res_callable: String = concat_4.bind("3", "4").callv(["1", "2"])
    var res_rlink_call: String = script.Get4().Bindv(["3", "4"]).RLinkCallv(["1", "2"])
    var res_rlink_await: String = await script.Get4().Bindv(["3", "4"]).RLinkCallvAwait(["1", "2"])
...
func test_unbind() -> void:
    ...
    var res_rlink1: String = script.Get5().Unbind(1).RLinkCallv(["1", "2", "5", "6", "7", "8"])
    var res_rlink1_await: String = await script.Get5().Unbind(1).RLinkCallvAwait(["1", "2", "5", "6", "7", "8"])
    ...
    var res_rlink4: String = script.Get2().Unbind(4).RLinkCallv(["1", "2", "5", "6", "7", "8"])
    var res_rlink4_await: String = await script.Get2().Unbind(4).RLinkCallvAwait(["1", "2", "5", "6", "7", "8"])
...
func test_bind_unbind() -> void:
    ...
    var res_rlink: String = script.Get3().Bindv(["3", "4"]).Unbind(1).RLinkCallv(["1", "2"])
    var res_rlink_await: String = await script.Get3().Bindv(["3", "4"]).Unbind(1).RLinkCallvAwait(["1", "2"])
...
func test_bind_unbind_bind_unbind() -> void:
    ...
    var res_rlink: String = script.Get4().Bindv(["3", "4"]).Unbind(2).Bindv(["1", "2", "5"]).Unbind(1).RLinkCallv(["6", "7"])
    var res_rlink_await: String = await script.Get4().Bindv(["3", "4"]).Unbind(2).Bindv(["1", "2", "5"]).Unbind(1).RLinkCallvAwait(["6", "7"])
    assert_eq(res_callable, res_rlink)
    assert_eq(res_callable, res_rlink_await)
    gut.p(res_callable)
...
func test_bind_unbind_bind_bind() -> void:
    ...
    var res_rlink: String = script.Get5().Bindv(["3", "4"]).Unbind(4).Bindv(["1", "2", "5"]).Bindv(["6", "7", "8"]).RLinkCall("10")
    var res_rlink_await: String = await script.Get5().Bindv(["3", "4"]).Unbind(4).Bindv(["1", "2", "5"]).Bindv(["6", "7", "8"]).RLinkCallAwait("10")
    assert_eq(res_callable, res_rlink)
    assert_eq(res_callable, res_rlink_await)
    gut.p(res_callable)
