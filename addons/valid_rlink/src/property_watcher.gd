...
func _init(ctx: Context, data: RLinkData, object_name: String) -> void:
...
func _ready() -> void:
    ...
    _timer.timeout.connect(call_validate_values)
...
func call_validate_values() -> void:
    if _data != null: 
        _data.validate_values(_object_name)
